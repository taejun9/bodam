...
REQUIREMENTS = {
    ...
    "docs/quality/windows-e2e-evidence.md": (
        ...
        "Plan-027 run `31185908075`",
        "job `92890241298`",
        "exact commit `e42ad20d75acb9f33c5529f2397b25e3796089ee`",
        "corrected CLR ancestor",
        "controls passed on actual Windows",
        "actual production Windows lifecycle is\n`PASS`",
        "installed full E2E result is `FAIL`",
        "installed E2E first spec is `2 PASS / 4 FAIL`",
        "remaining installed E2E scenarios are `NOT RUN`",
        "Artifact upload was skipped;\nartifacts: 0",
        "downloaded-artifact acceptance is `NOT RUN`",
        "explicit close-after-settle dismissal remediation's\nactual Windows result is `NOT RUN`",
    ),
    "docs/quality/windows-release-acceptance.md": (
        ...
        "job `92890241298`",
        "exact commit `e42ad20d75acb9f33c5529f2397b25e3796089ee`",
        "fixture controls passed on actual Windows",
        "actual production Windows lifecycle is\n`PASS`",
        "installed full E2E result is `FAIL`",
        "installed E2E first spec is `2 PASS / 4 FAIL`",
        "remaining installed E2E scenarios\nare `NOT RUN`",
        "Artifact upload was skipped; artifacts: 0",
        "downloaded-artifact acceptance is `NOT RUN`",
        "actual\nWindows result is `NOT RUN`",
    ),
